  ...
  return (
    <div className="h-full flex flex-col md:flex-row bg-[#C46F16] rounded-lg shadow-lg overflow-hidden">
      ...
      <div className="w-full md:w-1/2 p-4 md:p-6 flex flex-col justify-center">
        ...
        Hi there! I&apos;m Nicole Wanjala, a blogger, digital marketer and creativist with a passion for storytelling and empowering others.         
        </p>
        <p className="text-gray-600 mb-2">
            ...
            Over the years, I&apos;ve had the pleasure of working with diverse local and international companies, crafting engaging content, managing socials and creating digital communications and assets.
        </p>
        <p className="text-gray-600 mb-2">
         One of my memorable experiences was creating weekly content for five small businesses while at a digital marketing firm.
        ...
        <p className='text-lg font-semibold mb-6'>Get in touch today and let&apos;s find out how I can be of help to you or your business.</p>
